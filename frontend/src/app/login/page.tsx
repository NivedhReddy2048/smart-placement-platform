  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const userData = res.data.user || {
        name: "User",
        email: username, // Fallback, the backend should return actual user data
      ...
      localStorage.setItem("user_role", res.data.role || userData.role);
      
      console.log("TOKEN AFTER SAVE:", localStorage.getItem("access_token"));
      console.log("SESSION AFTER SAVE:", localStorage.getItem("auth_session"));
      console.log("ROLE AFTER SAVE:", localStorage.getItem("user_role"));
