...
export default function JobMatchesPage() {
  ...
  const processedJobs = useMemo(() => {
    return jobsData.map(job => {
      ...
      const insight = `You match ${current.matched.length}/${job.skills.length} skills. ${
        nextSkill ? `Adding ${nextSkill} increases your match to ${improvedPct}%.` : "You have achieved full core alignment for this role."
      }`;
